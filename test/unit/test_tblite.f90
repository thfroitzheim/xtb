...
subroutine test_gfn1_mindless_basic(error)
   ...
   character(len=*), parameter :: mindless(10) = [&
      ...
      & "mindless06", "mindless07", "mindless08", "mindless09", "mindless10"]
   real(wp), parameter :: ref_energies(10) = &
      &[-33.040345115781_wp, -26.858637903042_wp, -25.818131309454_wp, &
      & -24.896623137384_wp, -29.038403271958_wp, -20.596982576505_wp, &
      & -35.754243825064_wp, -33.088749111514_wp, -21.414820173177_wp, &
      & -26.650774569501_wp]
   real(wp), parameter :: ref_gnorms(10) = &
      &[0.049510570012608_wp, 0.062164747776809_wp, 0.050970566397999_wp, &
      & 0.089329574492273_wp, 0.049188966613709_wp, 0.059353966643586_wp, &
      & 0.063932340268411_wp, 0.059154281017514_wp, 0.043307764220264_wp, &
      & 0.043009324840974_wp]
   real(wp), parameter :: ref_hlgaps(10) = &
      &[3.4192955977944_wp, 1.6702606935679_wp, 2.4899512662496_wp, &
      & 1.6706475895573_wp, 2.4613135820079_wp, 3.9778639201986_wp, &
      & 2.5370073793248_wp, 1.3590765655343_wp, 4.0816037280637_wp, &
      & 1.3640455036507_wp]
